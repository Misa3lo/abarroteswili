    ...
    <div class="container">
        <div class="card shadow-sm col-md-10 mx-auto">
            ...
            <div class="card-body p-4">
                <form method="post" action="{{ route('personas.store') }}" class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                   name="nombre" id="nombre" value="{{ old('nombre') }}" required maxlength="100">
                            @error('nombre')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('apaterno') is-invalid @enderror"
                                   name="apaterno" id="apaterno" value="{{ old('apaterno') }}" required maxlength="100">
                            @error('apaterno')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('amaterno') is-invalid @enderror"
                                   name="amaterno" id="amaterno" value="{{ old('amaterno') }}" maxlength="100">
                            @error('amaterno')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control @error('telefono') is-invalid @enderror"
                                   name="telefono" id="telefono" value="{{ old('telefono') }}" maxlength="15"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('direccion') is-invalid @enderror"
                                   name="direccion" id="direccion" value="{{ old('direccion') }}" maxlength="255"
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Nota:</strong> Al registrar a la persona, posteriormente podrá asignarle un rol de Cliente o Usuario desde sus respectivos módulos.
                    </div>
